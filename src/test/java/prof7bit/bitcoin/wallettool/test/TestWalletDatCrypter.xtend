...
public class TestWalletDatCrypter {
     ...
     */
    @Test
    def test_decrypt() throws Exception {
        val pass        = "test"
        val salt        = "126ba59f232b334d".hex2bytes
        val iter        = 171900
        ...
        val dec_actual = crypter.decrypt(encrypted)
        Assert.assertArrayEquals(decrypted, dec_actual)
    }

    /**
     * decrypting an encrypted private key with master key and iv
     */
    @Test
    def test_decrypt2() throws InvalidCipherTextException {
        val iv          = "7aa9308e3ab81b4c3e98596f0beafe16".hex2bytes
        val master_key  = "ee54f57cfe1038fc4664d71de3507406db2a4a67082e19375992a2a17c585f07".hex2bytes
        ...
        crypter.setKeyAndIV(master_key, iv)
